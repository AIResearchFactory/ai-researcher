...
impl AIService {
    ...
    pub async fn chat(&self, messages: Vec<Message>, system_prompt: Option<String>) -> Result<ChatResponse> {
        ...
        // Tools are disabled/removed for now in this iteration.
    ...
    pub async fn switch_provider(&self, provider_type: ProviderType) -> Result<()> {
        ...
        // if let Err(e) = new_provider.validate_config().await {
        //     return Err(anyhow!("Failed to validate provider config: {}", e));
        // }
