...
import { BrainCircuit, FileText, Settings, Play } from 'lucide-react';
...
const StepNode = memo(({ data, selected }: NodeProps<any>) => {
    const { label, skillName, status, onEdit } = data as StepNodeData;
    ...
    `}>
            ...
            <Handle
                ...
                className="!w-3 !h-3 !bg-gray-400 dark:!bg-gray-500 !-top-1.5"
            />

            <div className="p-3">
                {/* Header */}
                <div className="flex items-center gap-2 mb-2">
                    <div className={`p-1.5 rounded-md ${status === 'Running' ? 'animate-pulse bg-blue-100 text-blue-700' : 'bg-purple-100 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400'}`}>
            ...
            <Handle
                ...
                className="!w-3 !h-3 !bg-gray-400 dark:!bg-gray-500 !-bottom-1.5"
            />
        </div>
    );
});
